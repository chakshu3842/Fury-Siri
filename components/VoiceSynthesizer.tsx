    ...
    <div className="flex flex-col items-center justify-center text-white">
        {displaySettings && (
            ...
            <div className="w-fit">
                ...
                className="flex-1 bg-gray-500 text-white border border-gray-300 text-sm
                rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 
                dark:bg-gray-700
                dark:border-gray-600 dark:placeholder-gray-400 dark:foucs:ring-gray-500
                dark:foucs:border-gray-500 ">
